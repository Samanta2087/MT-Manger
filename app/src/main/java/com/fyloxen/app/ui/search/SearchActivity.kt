package com.fyloxen.app.ui.search
        ...
        when {
            item.isTextFile() -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.editor.FileEditorActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.editor.FileEditorActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
            item.isImageFile() -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.viewer.ImageViewerActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.viewer.ImageViewerActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
            item.isAudioFile() -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.viewer.AudioPlayerActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.viewer.AudioPlayerActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
            item.isVideoFile() -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.viewer.VideoPlayerActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.viewer.VideoPlayerActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
            item.extension == "pdf" -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.viewer.PdfViewerActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.viewer.PdfViewerActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
            ...
            item.extension in setOf("docx", "odt") -> {
                startActivity(android.content.Intent(this,
                    com.fyloxen.app.ui.viewer.DocxViewerActivity::class.java).apply {
                    putExtra(com.fyloxen.app.ui.viewer.DocxViewerActivity.EXTRA_FILE_PATH,
                        file.absolutePath)
                })
            }
