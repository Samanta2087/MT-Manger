...
import com.fyloxen.app.utils.SyntaxHighlighter
...
class LineAdapter(
    ...
    override fun onBindViewHolder(holder: LineVH, position: Int) {
        ...
        if (isSelectAllActive) {
            holder.b.root.setBackgroundColor(0x55264F78)
            holder.b.activeLineHighlight.visibility = View.GONE
            holder.b.etLine.isInSelectAllMode = true
            holder.b.etLine.setText(lineText)
            val span = BackgroundColorSpan(0x554FC3F7.toInt())
            holder.b.etLine.editableText?.setSpan(span, 0, lineText.length, android.text.Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        } else {
            holder.b.root.background = null
            holder.b.activeLineHighlight.visibility = View.GONE
            holder.b.etLine.isInSelectAllMode = false
            holder.b.etLine.setText(lineText)
        }
        ...
        holder.b.etLine.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                ...
                if (isSelectAllActive) {
                    ...
                    holder.b.root.setBackgroundColor(holder.itemView.context.getColor(com.fyloxen.app.R.color.editor_active_line))
                }
