package com.mtmanager.lite.ui.pane
...
import com.mtmanager.lite.databinding.FragmentFilePaneBinding
...
import com.mtmanager.lite.utils.ZipUtils
...
class FilePaneFragment : Fragment() {
    ...
    private fun setupFileList() {
        ...
        binding.fileListRv.apply {
            ...
            itemAnimator = null   // disable add/remove flicker during DiffUtil updates
        }
    }
    ...
    private fun loadFiles(animate: Boolean = false) {
        // Cancel any in-flight load — only the latest navigation wins
        loadJob?.cancel()
        if (animate) {
            binding.fileListRv.alpha = 0f
            binding.fileListRv.translationY = 12f
        }
    ...
    private fun handleItemLongClick(item: FileItem, anchor: View) {
        ...
        val sheetStyle = if (com.mtmanager.lite.utils.ThemeManager.isLightGlass(requireContext()))
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (result.isSuccess) {
                ...
                if (isWrongPassword) {
                    ...
                    val fakeItem = com.mtmanager.lite.model.FileItem(zipFile)
    ...
    private fun shareFile(file: File) {
        try {
            ...
            val intent = android.content.Intent(android.content.Intent.ACTION_SEND).apply {
                type = com.mtmanager.lite.model.FileItem(file).mimeType()
